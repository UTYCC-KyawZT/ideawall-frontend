        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              With Idea Wall, staying organized is a breeze. Create as many
              Walls (folders) as you need to categorize your ideas. Keep your
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Collaboration knows no bounds with Idea Wall. Share your Walls
              with friends, colleagues, or family and engage in real-time
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Your ideas, your control. Idea Wall allows you to customize
              sharing settings for each Wall. Decide who can view or edit your
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Designed for a seamless user experience, Idea Wall&apos;s intuitive UI
              lets you focus on what matters most: your ideas. Powered by React
